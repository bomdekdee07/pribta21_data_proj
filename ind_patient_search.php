...
<style>
	...
	#divFindRes .divdatarow:hover{
		filter: brightness(80%);
	}
</style>
<body id='pribtaBody' >
	<div id='pribta21' class='fl-wrap-col' style='overflow: hidden'>
		<div class='fl-wrap-row' style='overflow: hidden'>
			<div id='divQList' class='fl-fix' style='min-width:150px'>
				<? $_GET["hidename"]=1; include("queue_inc_list.php"); ?>
			</div>
			<div class='fl-wrap-col fl-fill'  style='overflow: hidden;font-size:12px'>
				<div class='fl-fix fl-mid' style='background-color: #00c1d0;min-height:60px;border-bottom:1px solid black'>
					...
					<div class='fl-fill'>
						<div>Name</div>
						<div><input class='uidfinder' data-ftype='name' style='width:80px'  id='txtF_Name' /></div>
					</div>
					<div class='fl-fill'>
						<div>DOB</div>
					...
					<div class='fl-fill'>
						...
						<div><input class='uidfinder' data-ftype='id' style='width:100px'  id='txtF_Id' /></div>
					</div>
					<div class='fl-fill'>
						<div>Phone</div>
...
<script>
	...
	$(function(){
		...
		function refreshQ(){
			$("#divQList").load("queue_inc_list.php?hidename=1");
		}
