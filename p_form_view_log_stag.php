...
if($txt_col_data != ""){
  ...
  <div class='fl-wrap-col div-log-main' data-formid='$form_id' data-visitid='$visit_id' data-uid='$uid' data-row_height='$form_row_height' data-projid='$sProjid'>
...
$(".div-log-info .tp-input").on("focusout",function(){
  ...
  // let sRowid = $(this).parent().parent().parent().attr('data-rowid');
   ...
   let sFormid = $('.div-log-main').attr('data-formid');
   let sUID = $('.div-log-main').attr('data-uid');
   let sProjid = $('.div-log-main').attr('data-projid');
