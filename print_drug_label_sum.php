...
where JSO.collect_date = ? and JSO.collect_time = ? and JSO.uid = ? and JSO.supply_code = ?
...
if($stmt->execute()){
	...
	while ($stmt->fetch()) {
		...
		$sum_amt = $sum_amt+$total_amt;
		$aRes["total_amt"] = $sum_amt;
