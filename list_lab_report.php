...
//GET FORM
	...
	left JOIN p_lab_result lab_rs on(lab_rs.lab_id = PLOLT.lab_id and lab_rs.uid = PLOLT.uid AND lab_rs.collect_date = PLOLT.collect_date AND lab_rs.collect_time = PLOLT.collect_time)
...
//GET LAB RESULT
	...
	WHERE  PLT.is_disable=0 AND  PLOLT.uid=? AND PLOLT.collect_date=? AND PLOLT.collect_time=? ORDER BY external_lab,PLT.lab_group_id,PLT.lab_id2";
