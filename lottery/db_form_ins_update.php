<?
    ...
    if($flag_auth != 0){
        ...
        if($u_mode == "create_item"){
            ...
            $tbl_name = "items_master";
            $lst_data_update = array();
            if($flag_auth == 1){      
                $lst_data_update["item_code"] = $itemCode;
                $lst_data_update["upd_by"] = $sid;
        ...
        // CREATE AWARD
        if($u_mode == "create_award"){
            $itemCode = getQS("item_code");
            $number = getQS("correct_number");
            $date = getQS("upd_date");
            $sid = getQS("sid");
            $data_obj_list = isset($_POST["dataid"])?$_POST["dataid"] : [];
            ...
            $tbl_name = "award_number";
            $lst_data_update = array();
            if($flag_auth == 1){      
                $lst_data_update["item_code"] = $itemCode;
                $lst_data_update["upd_date"] = $date;
                $lst_data_update["correct_number"] = $number;
