...
$sHtml = "";
$query = "SELECT  FLD.data_seq, FLD.data_id, FLD.data_type as comp_data_type,DL.data_type, FLD.data_value,FLD.is_require,
...
if($stmt->execute()){
  ...
  $stmt->bind_result($data_seq,  $data_id,$comp_data_type,  $data_type, $data_value, $is_require,
...
*/
      ...
      if($data_type == "text" || $data_type == "date"){
        ...
        $sHtml .= "<option  value='' disabled>เลือก [$data_desc]</option>";
        $sHtml .= $select_option;
        $sHtml .= "</SELECT>";
...
if($collect_time == '00:00:00'){
  ...
  if($div_form_data_import_txt != ""){
    $div_form_data_import_txt = "
      <span class='mx-4 px-1 pt-2 ptxt-white ptxt-s10 bg-mdark2 form-title'>Import Form:
...
<div class='div-form-view fl-wrap-col bg-msoft2 '
 data-uid='$uid' data-formid='$form_id' data-projid='$sProjid' data-visitid='$sVisitid'   data-coldate='$collect_date' data-coltime='$collect_time' data-sid='$s_id' data-visitstatus='$sVisitstatus' data-nextformid='$sNFormId' data-nextformlist='$qsNextForm'>
  <div class='fl-wrap-col fl-auto'>
    <div class='fl-fix fl-mid ph20'>

       <span class='px-1 ptxt-white pbg-blue form-title'>Form: $form_name_th</span>$form_protocol_version
