...
<div id="sub_group_create_main" class="fl-wrap-col appointments-mt-1" style="min-width:500;">
    <div id="data-defult" data-grouptype="<? echo $group_type; ?>" data-groupcode="<? echo $group_code; ?>"></div>
...
<script>
    $(document).ready(function(){
        ...
        $("#sub_group_create_main [name=supply_group_type]").unbind("click");
        ...
        if($("#sub_group_create_main #data-defult").data("groupcode") == ""){
            ...
            $("#sub_group_create_main #btn_save_form_view").off("click");
                ...
                $.ajax({url: "supply_management_ajax_group_type.php", 
                    ...
                    success: function(result){
                        if(result == 1){
                            ...
                            var type_check = $("#sub_group_create_main [name=supply_group_type]").val();
                            var code_check = $("#sub_group_create_main [name=supply_group_code]").val();

                            if(type_check != "" || code_check != ""){
                                saveFormData_sub_group();
                            }
                            else{
                                alert("กรุณาเลือกประเภทและกรอกข้อมูลให้ครบถ้วน!");
                            }
                        }
                }});
            });
    ...
    function saveFormDataComplete_sub_group(flagSave, aData, rtnDataAjax){
        ...
        $("#sub_group_create_main #btn_cancel").click();
    }
</script>