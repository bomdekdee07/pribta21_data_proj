...
<div class="fl-wrap-col" id="patient_system_main">
    ...
    <div class="fl-wrap-row h-45">
        <div class="fl-fill fl-mid smallfont3">
            <span style="color: #808B96;">โปรดเข้าสู่ระบบด้วยบัญชีคนไข้เพื่อทำการนัดหมาย</span>
        </div>
    </div>
...
<script>
    $(document).ready(function(){
        ...
        $("#patient_system_main .button-login").on("click", function(){
            var aData = {
                user: $("#patient_system_main #username").val(),
                pass: $("#patient_system_main #password").val()
            };
