<?
    ...
    if(count($data_sub_group) > 0){
        foreach($data_sub_group as $key => $value){
            $sJS .= '<div id="detail_sub_group" class="fl-wrap-row row-color h-25" style="margin-left: 2px; margin-top: 3px">';
            ...
            $sJS .=     '</div>';
            $sJS .=     '<div class="fl-fix holiday-text-detail holiday-smallfont2 check-type" style="min-width: 114px;">';
            $sJS .=         '<span>'.$value["group_type"].'</span>';
            $sJS .=     '</div>';
            $sJS .=     '<div class="fl-fix holiday-text-detail holiday-smallfont2" style="min-width: 200px;">';
...
<script>
    $(document).ready(function(){
        ...
        $("#detail_sub_group .sub-group-edit").on("click", function(){
            ...
            var sUrl_appoint = "supply_management_inc_sub_group_create.php?group_type="+group_type+"&group_code="+group_code;
