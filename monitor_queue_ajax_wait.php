<?
    ...
    $data_sid = "";
    if($sid == "D07" || $sid == "D03"){
        $query = "select CONCAT(main.queue, '*', main.room_no, ':', sub.section_id, '#', main.queue_call) as queue
        from i_queue_list as main, i_room_list as sub
        where main.collect_date = ?
        and main.clinic_id = ?
        and main.queue_call in (0, 1, 2)
        ...
        order by main.queue_call, main.queue_datetime;";
