        ...
        <div class='fl-wrap-row'>
            ...
            <div class='fl-wrap-col right-div wper-35'>
                ...
                <div class='fl-wrap-row h-30 fw-b'>
                    <div id='btnAddDrug' class='fl-fix wper-20 fl-mid f-border fabtn' style="background-color: #58D68D">Add</div>
                    <div class='fl-fill'></div>
                    <div id='btnAddLab'  class='fl-fix wper-20 fl-mid f-border fabtn' style="background-color: #58D68D">Lab</div>
                </div>
                <div id="divTotalMedicine" class='fl-fill border'>
                    <? include("medicine_inc_total_value.php"); ?>
                </div>
                <div id="divTotalBill" class='fl-fill border'>
...
<script>
            ...
            success: function(sResult){
                setTimeout(function(){
                    setInterval(function(){
                        if(sResult == true){
                            // console.log("inQueue:"+sResult);
                            saveFormData_doctor_auto();
                        }
                    }, 14000)}, 
                1000);
            }
    ...
    function saveFormData_doctor_auto(){
